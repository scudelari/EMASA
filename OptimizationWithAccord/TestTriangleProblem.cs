...
{
    [Serializable]
    public class TestTriangleProblem : ProblemBase
    {

        
        public TestTriangleProblem(SolverType inSolverType) : base(inSolverType, new TestTriangleObjectiveFunction())
        {
    ...
    {
        public double targetLength = 40d;
        ...
        protected override void InitializeVariables()
        {
            ...
            FinalDefs.Add(new Double_Output_ParamDef("L1 Side Length", 
                inTargetValue: targetLength, inExpectedScale: new DoubleValueRange(0d,200d)));
