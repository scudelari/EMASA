...
namespace BaseWPFLibrary.Forms
{
    ...
    {
        public static ExceptionViewer Show(Exception e, string headerMessage = "An issue occurred.")
        {
            ExceptionViewer ev = new ExceptionViewer(headerMessage, e);
            
            // Focuses on the current application
            PInvokeWrappers.SetForegroundWindow(Process.GetCurrentProcess().MainWindowHandle);
