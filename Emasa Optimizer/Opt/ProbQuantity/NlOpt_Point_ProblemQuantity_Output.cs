            ...
            get
            {
                ...
                switch (Quantity.QuantitySource)
                {
                    case FeResultClassification feResultClassification:
                        {
                            // Gets the FeGroup
                            FeGroup group = _ownerNlOptPoint.FeModel.Groups[Quantity.QuantityAggregatorOptions.EntityToFilter.Name];
                            ...
                            switch (feResultClassification.ResultFamily)
                            {
                                ...
                                case FeResultFamilyEnum.Nodal_Displacement:
                                    ...
                                    {
                                        FeMeshNode node = _ownerNlOptPoint.FeModel.MeshNodes[inRow.Field<int>("Mesh Node Id")];
                                ...
                                case FeResultFamilyEnum.ElementNodal_BendingStrain:
                                    ...
                                    {
                                        FeMeshNode node = _ownerNlOptPoint.FeModel.MeshNodes[inRow.Field<int>("Mesh Node Id")];
                                        FeMeshBeamElement beam = _ownerNlOptPoint.FeModel.MeshBeamElements[inRow.Field<int>("Element Id")];
                                ...
                                case FeResultFamilyEnum.SectionNode_Strain:
                                    filteredRowsEnumerable = RawDataTable.AsEnumerable().Where(inRow =>
                                    {
                                        FeMeshNode node = _ownerNlOptPoint.FeModel.MeshNodes[inRow.Field<int>("Owner Mesh Node Id")];
                                        FeMeshBeamElement beam = _ownerNlOptPoint.FeModel.MeshBeamElements[inRow.Field<int>("Element Id")];
